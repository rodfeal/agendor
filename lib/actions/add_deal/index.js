...
const getOrganizationId = (plg, event) => {
  ...
  organization.contact.work = (organization.contact.work || '').split('').reverse().slice(0, 11).reverse().join('');
...
const getPersonId = (plg, event, organizationId) => {
  ...
  person.contact.work = (person.contact.work || '').split('').reverse().slice(0, 11).reverse().join('');
