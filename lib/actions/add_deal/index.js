...
const getOrganizationId = (plg, event) => {
  ...
  if ((organization.contact.work || '').length > 0){
    organization.contact.work = ('00000000000'+organization.contact.work).split('').reverse().slice(0, 11).reverse().join('');
  }
  if ((organization.contact.mobile || '').length > 0){
    organization.contact.mobile = ('00000000000'+organization.contact.mobile).split('').reverse().slice(0, 11).reverse().join('');
  }
...
const getPersonId = (plg, event, organizationId) => {
  ...
  if ((person.contact.work || '').length > 0){
    person.contact.work = ('00000000000'+person.contact.work).split('').reverse().slice(0, 11).reverse().join('');
  }
  if ((person.contact.mobile || '').length > 0){
    person.contact.mobile = ('00000000000'+person.contact.mobile).split('').reverse().slice(0, 11).reverse().join('');
  }
